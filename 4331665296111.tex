...
\begin{itemize}
\textbackslash\{\}item Developed chatbot backend with Python Flask and integrated NLP capabilities.
\textbackslash\{\}item Designed conversational flows to handle 80\textbackslash\{\}\% of common inquiries without human aid.
\textbackslash\{\}item Used MongoDB for dynamic data storage and fast retrieval.
\textbackslash\{\}item Implemented CI/CD pipelines for seamless deployment and updates.
\end{itemize}
